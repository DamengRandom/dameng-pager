...
import AIExploreCards from '~/components/ai-explore/AIExploreCards.vue'
import AIExploreTimeline from '~/components/ai-explore/AIExploreTimeline.vue'
import AIExploreGrid from '~/components/ai-explore/AIExploreGrid.vue'
...
const aiExploreComponents = [AIExploreCards, AIExploreTimeline, AIExploreGrid]
...
const aiExploreComponent = computed(() => aiExploreComponents[layout.value.aiExplore - 1])
