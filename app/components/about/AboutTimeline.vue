...
<template>
  <section class="py-28 px-6 bg-black">
    <div class="max-w-[740px] mx-auto">
      <h2 v-reveal="'fade-up'" class="text-4xl font-semibold text-white tracking-tighter leading-[1.1] mb-10">About</h2>

      <div class="border-l border-[#333] ml-2 pl-8 space-y-10">
        <!-- Bio -->
        <div v-reveal:1="'fade-left'" class="relative">
          <span class="absolute -left-[37px] top-1.5 w-3 h-3 rounded-full bg-sky-500 ring-4 ring-black" />
          ...
          <p class="text-[#ccc] text-sm leading-relaxed tracking-tight">{{ copy.bio }}</p>
        </div>

        <!-- Current Work -->
        <div v-reveal:2="'fade-left'" class="relative">
          <span class="absolute -left-[37px] top-1.5 w-3 h-3 rounded-full bg-orange-500 ring-4 ring-black" />
        ...
        <div v-reveal:3="'fade-left'" class="relative">
          <span class="absolute -left-[37px] top-1.5 w-3 h-3 rounded-full bg-violet-500 ring-4 ring-black" />
          ...
          <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
            <template v-for="(item, idx) in about.learning" :key="item">
              <span class="text-[#ccc] text-sm tracking-tight">{{ item }}</span>
        ...
        <div v-reveal:4="'fade-left'" class="relative">
          <span class="absolute -left-[37px] top-1.5 w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-black" />
