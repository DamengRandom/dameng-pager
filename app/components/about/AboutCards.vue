...
<template>
  <section class="py-28 px-6 bg-[#f5f5f7]">
    <div class="max-w-[980px] mx-auto">
      ...
      <h2 v-reveal:1="'fade-up'" class="text-4xl font-semibold text-[#1d1d1f] tracking-tighter leading-[1.1] mb-3">About Me</h2>
      <Separator class="border-[#d2d2d7] mb-10" />

      <!-- Bio -->
      <div v-reveal:2="'fade-up'" class="bg-white rounded-2xl p-8 text-[#1d1d1f] leading-relaxed text-base tracking-tight mb-6 shadow-[rgba(0,0,0,0.04)_0px_2px_12px_0px]">
        {{ copy.bio }}
      </div>

      <!-- Stat Cards -->
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-reveal:3="'scale'" class="bg-white rounded-2xl p-6 shadow-[rgba(0,0,0,0.04)_0px_2px_12px_0px] hover:shadow-[rgba(0,0,0,0.08)_0px_4px_20px_0px] transition-shadow duration-250 hover-lift">
        ...
        <div v-reveal:4="'scale'" class="bg-white rounded-2xl p-6 shadow-[rgba(0,0,0,0.04)_0px_2px_12px_0px] hover:shadow-[rgba(0,0,0,0.08)_0px_4px_20px_0px] transition-shadow duration-250 hover-lift">
          <div class="flex items-center gap-2 mb-3">
        ...
        <div v-reveal:5="'scale'" class="bg-white rounded-2xl p-6 shadow-[rgba(0,0,0,0.04)_0px_2px_12px_0px] hover:shadow-[rgba(0,0,0,0.08)_0px_4px_20px_0px] transition-shadow duration-250 hover-lift">
          <div class="flex items-center gap-2 mb-3">
